...
type UserServiceClient interface {
	...
	SignIn(ctx context.Context, in *SignInReq, opts ...grpc.CallOption) (*SignInResponse, error)
}
...
func (c *userServiceClient) SignIn(ctx context.Context, in *SignInReq, opts ...grpc.CallOption) (*SignInResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type UserServiceServer interface {
	...
	SignIn(context.Context, *SignInReq) (*SignInResponse, error)
...
func (UnimplementedUserServiceServer) SignIn(context.Context, *SignInReq) (*SignInResponse, error) {
